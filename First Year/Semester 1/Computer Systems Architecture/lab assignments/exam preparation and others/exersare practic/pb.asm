...
segment code use32 class=code
    start:
        ...
        call [fopen]
        add esp, 4*2 ;eax=file_descriptor_file_we_read_from, adica nr de caractere din fisierul din care citim
        ...
        read_loop:
            ...
            push dword 1 ;we read one byte at a time, so one char (the size of one char is a byte), how many items we read, so 1*1(1 char*1byte-cat de mult citim)
